...
List<int> requestStatus = [0xAA, 0x05, 0x00,0x05, 0xBB]; // make sure that it is the right packet'
...
bool isOn = false;
bool isSynced = false;
int sequentialDelay = 200;
int sequentialSlider = 200;
int toggleDelay = 200;
int toggleSlider = 200;
